...
public class HashDoubleHashingTest {
    ...
    public void Should_ThrowIllegalArgumentException_When_TableSizeLesserThanOne() {
        ...
        HashTable<String> hashTable = new HashDoubleHashing<>(illegalSize);
    }
    ...
    public void Should_IncreaseCountOfElement_When_PutUniqueElement() {
        HashTable<Integer> hashTable = new HashDoubleHashing<>();
        for (int i = 1; i <= 3; i++) {
            hashTable.put(i);
    ...
    public void Should_NotResize_When_TryToPutDuplicate() {
        ...
        int expectedSize = 2;
        int elem = 1;
        HashTable<Integer> hashTable = new HashDoubleHashing<>(initialSize);
        for (int i = 1; i <= 10; i++) {
            hashTable.put(elem);
        }
    ...
    public void Should_DoubleResize_When_LoadFactorBeforePutIsBiggerThanNeeded() {
        int size = 1;
        int expectedSize = 2;
        HashTable<String> hashTable = new HashDoubleHashing<>(size);
    ...
    @Test
    public void ShouldCorrectlyDelete_When_ElementIsPresentInTable() {
        HashTable<String> hashTable = new HashDoubleHashing<>();
        String elem = "element";
        hashTable.put(elem);
    ...
    @Test
    public void ShouldCorrectlyDelete_When_ElementIsNotPresentInTable() {
        HashTable<String> hashTable = new HashDoubleHashing<>();
